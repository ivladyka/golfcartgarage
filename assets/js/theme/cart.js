...
export default class Cart extends PageManager {
    onReady() {
        ...
        if (window.Extend && window.ExtendBigCommerce) {
            ExtendBigCommerce.normalizeCart({ balance: true }, function(err, data) {
        ...
        //                         addPlanToCart(sku, plan, quantity, cart)
        //                         return;
        //                     }
        ...
        //                         { cartId, itemId }, 
        //                         function() { 
        //                             ExtendBigCommerce.addCartItem({ cartId, productId, variantId, quantity })
        //                             addPlanToCart(sku, plan, quantity, cart) 
        //                         }
        //                     )
        //                 },
    ...
    refreshContent(remove) {
        ...
        utils.api.cart.getContent(options, (err, response) => {
            ...
            //                     if (pItem.sku === sku) return pItem.name
            //                 })
            //                 planToNameMap[customId] = product.name
            //             }
            //         })

            //         findAll('#extend-plan-item').forEach(function(el) {
            //             var cartItemId = el.getAttribute("data-extend-itemid")
            //             if (planToNameMap[cartItemId]) {
            //                 el.innerText = 'For: ' + planToNameMap[cartItemId]
            //             }
            //         })
            //         findAll('#extend-cart-offer').forEach( function(el) {
            //             var sku = el.getAttribute("data-extend-sku");
